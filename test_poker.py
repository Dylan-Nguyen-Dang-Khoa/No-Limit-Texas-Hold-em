...
hand_evaluation = HandEvaluator({0: [Card("9", "Hearts"), Card("7", "Spades")], 1: [Card("8", "Spades"), Card("King", "Hearts")], 2: [Card("Ace", "Clubs"), Card("7", "Clubs")]}, [Card("6", "Clubs"), Card("4", "Diamonds"), Card("Queen", "Hearts"), Card("Jack", "Hearts"), Card("4", "Clubs")])
